  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* User-added badge */}
        {isUserAdded && (
          <div className="absolute -top-1 -right-1 w-3 h-3 bg-warning-400 rounded-full border-2 border-white" />
        )}
      </div>
      {/* Pin point */}
      <div
      ...
      {/* Tooltip on hover */}
      {isHighlighted && (
        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 px-3 py-1.5 bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-900 text-sm rounded-lg whitespace-nowrap shadow-lg z-20 max-w-[200px] truncate">
          {locationName}
    ...
    <div className="w-full h-full relative">
      ...
      >
        ...
        {visibleLocations.map((location) => {
          ...
          const dayColor = meta ? getDayColor(meta.dayNumber) : '#6366f1';
      ...
      {/* Empty state overlay */}
      {locations.length === 0 && (
        <div className="absolute inset-0 flex items-center justify-center bg-neutral-100 dark:bg-neutral-800 bg-opacity-80 dark:bg-opacity-80 pointer-events-none">
